...
const tocItems = [
  { href: "#what-is-lithium", label: "What Lithium Actually Is" },
  { href: "#how-price-works", label: "How the Lithium Price Works" },
  { href: "#why-crashed", label: "Why It Crashed 86% — The Full Story" },
  { href: "#where-now", label: "Where We Are Now: The Setup" },
  { href: "#deficit-thesis", label: "The Supply Deficit Thesis" },
  { href: "#bull-bear", label: "Bull Case vs Bear Case, Fairly" },
  { href: "#ways-to-invest", label: "5 Ways to Invest in Lithium" },
  { href: "#etfs", label: "Lithium ETFs: LIT, REMX, BATT" },
  { href: "#miners", label: "Lithium Mining Stocks Guide" },
  { href: "#etf-vs-miner", label: "ETF vs Individual Miner: Which Wins?" },
  { href: "#short-selling", label: "Short Selling & Bearish Strategies" },
  { href: "#timing", label: "Timing and Positioning" },
  { href: "#taxes", label: "Lithium Investment Taxes" },
  { href: "#asx-guide", label: "Buying Australian Stocks (ASX) from US" },
  { href: "#signals", label: "6 Signals to Monitor" },
  { href: "#battery-chemistry", label: "Battery Chemistry: LFP vs NMC vs NCA" },
  { href: "#country-analysis", label: "Country Deep-Dives: Chile, Australia, Argentina, China" },
  { href: "#greenbushes", label: "Greenbushes: The Most Important Asset" },
  { href: "#ira-policy", label: "IRA & CRMA Policy Impact" },
  { href: "#battery-makers", label: "CATL, BYD, LG — Battery Makers" },
  { href: "#battery-recycling", label: "Battery Recycling as Supply Source" },
  { href: "#price-conversions", label: "Price Conversions & Reference Table" },
  { href: "#long-term", label: "Long-Term Outlook 2030–2035" },
  { href: "#history", label: "Price History 2010–2026" },
  { href: "#forecast", label: "Price Forecast 2026–2028" },
  { href: "#allocation", label: "How Much to Allocate" },
  { href: "#glossary", label: "Lithium Glossary" },
  { href: "#faq", label: "Lithium Investing FAQ" },
];
    ...
    <>
      ...
      <div className="bg-white border-b border-bdr/70">
        <div className="max-w-[1600px] mx-auto px-6 md:px-10 lg:px-16 py-2 text-xs text-muted" aria-label="Breadcrumb">
          ...
          {" › "}
          <a href="/lithium/" className="text-muted hover:underline">Lithium Data</a>
          {" › Lithium Investing 101"}
        </div>
      </div>

      {/* HERO */}
      <div className="bg-ink relative overflow-hidden" role="banner">
